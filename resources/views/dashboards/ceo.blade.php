...
@section('content')
    <div style="margin-bottom: 2rem;">
        ...
        <p style="color: #7f8c8d;">CEO Dashboard - Executive Overview</p>
    </div>
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1.5rem; margin-bottom: 2rem;">
        <div style="background: linear-gradient(135deg, #27ae60 0%, #2ecc71 100%); color: white; padding: 2rem; border-radius: 8px; text-align: center; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
            <div style="font-size: 2.5rem; font-weight: bold; margin-bottom: 0.5rem;">{{ $passCount }}</div>
            <div style="font-size: 1rem; opacity: 0.9;">Students Passed</div>
        </div>
        <div style="background: linear-gradient(135deg, #e74c3c 0%, #c0392b 100%); color: white; padding: 2rem; border-radius: 8px; text-align: center; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
            <div style="font-size: 2.5rem; font-weight: bold; margin-bottom: 0.5rem;">{{ $failCount }}</div>
            <div style="font-size: 1rem; opacity: 0.9;">Students Failed</div>
        </div>
    </div>
    ...
    <div class="card" style="background-color: #d1ecf1; border-left: 4px solid #0c5460;">
        <p style="color: #0c5460; margin: 0;">
            <strong>ℹ️ CEO Access:</strong> You have read-only access to all student and course data for reporting purposes. To make changes, contact a Staff member.
        </p>
    </div>
